...
function usageText(): string {
    return [
        "Usage:",
        "  tsx typescript/src/client/cli.ts discover --rpc <url>",
        "  tsx typescript/src/client/cli.ts decode-transaction --rpc <url> --signature <signature>",
        "  tsx typescript/src/client/cli.ts inspect --action mint|redeem ...",
        "  tsx typescript/src/client/cli.ts quote-mint ...",
        "  tsx typescript/src/client/cli.ts mint ...",
        "  tsx typescript/src/client/cli.ts quote-redeem ...",
        "  tsx typescript/src/client/cli.ts redeem ...",
        "",
        "Discovery and evidence options:",
        "  --rpc <url>",
        ...
        "  --mode direct|delegated|trilateral",
